    ...
    <div className="404">
      ...
      <div className="competition-div">
        ...
        <hr color="#ffffff"/>
          ...
          <Collapse in={year2019}>
              <h3 className="competition">
                  December - Won the <a className="competition-link" href="https://www.congressionalappchallenge.us/" target="blank">Congressional App Challenge</a> for Maryland <a className="competition-link" href="https://www.congressionalappchallenge.us/19-MD03" target="blank">District MD-03</a><br />
                  August - Got my 2nd Degree Black Belt in Tae-Kwon-Do (at <a className="competition-link" href="http://musamd.com" target="blank">Musa Martial Arts</a>)<br />
                  March - 2nd Place for JHU-APL MESA <a className="competition-link" href="https://secwww.jhuapl.edu/stem/mesa/school-based-program/competitions" target="blank">Alice Middle School Coding Competition</a> (as <a className="competition-link" href="https://www.youtube.com/channel/UCO_5muSlEd5sDPZyKTuJbNA/" target="blank">STEM Thunders</a>)
              </h3>
          </Collapse><br/>
